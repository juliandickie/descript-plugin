...
2. Run: `descript publish --project-id <ID> --composition-id <CID> --media-type Video --resolution 1080p --access-level <public|unlisted|drive|private> --json` (omit --access-level to use the Drive's default).
