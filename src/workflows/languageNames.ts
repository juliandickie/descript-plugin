...
for (const [code, segment] of SEGMENTS) BY_LOWER.set(code.toLowerCase(), segment);
 ...
 */
export function segmentForCode(code: string): string | undefined {
 ...
 */
export function unknownCodeHint(code: string): string {
